...
function Footer() {
  return (
    <div className='lg:w-screen lg:h-80 bg-black flex flex-row w-96 h-40'>
...
<a href="#contact" className='text-white font-bold lg:mt-2 mt-1 hover:underline'>Contact</a>
<a href="#about" className='text-white font-bold lg:mt-2 mt-1 hover:underline'>About</a>
<a href="#skills" className='text-white font-bold lg:mt-2 mt-1 hover:underline'>Skills</a>
<a href="#services" className='text-white font-bold lg:mt-2 mt-1 hover:underline'>Services</a>
