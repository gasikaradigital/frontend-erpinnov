...
className='lg:w-96 lg:h-96 w-60 h-60 shadow-xl rounded-2xl lg:ml-14 ml-12 lg:mt-10 mt-5 bg-white p-2 '>
...
className='lg:w-96 lg:h-96 w-60 h-60 shadow-xl rounded-2xl lg:ml-14 lg:mt-10 ml-12 mt-5 bg-white p-2'>
